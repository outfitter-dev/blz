...
async fn fetch_and_index_variants(
    ...
    for candidate in &mut candidates {
        ...
        storage.save_flavor_content(alias, &candidate.file_name, &content)?;
        ...
        storage.save_flavor_json(alias, &candidate.flavor_id, &llms_json)?;
        ...
        storage.save_source_metadata_for_flavor(alias, &candidate.flavor_id, &metadata)?;
