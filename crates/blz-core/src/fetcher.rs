...
use reqwest::header::{ETAG, IF_MODIFIED_SINCE, IF_NONE_MATCH, LAST_MODIFIED, CONTENT_LENGTH};
...
impl Fetcher {
    ...
    pub async fn check_flavors(&self, url: &str) -> Result<Vec<FlavorInfo>> {
        ...
        if let Some(filename) = url.split('/').last() {
            if filename.starts_with("llms") && filename.ends_with(".txt") && 
...
mod tests {
    ...
    fn test_extract_base_url() {
        assert_eq!(extract_base_url("https://example.com/llms.txt"), "https://example.com");
        assert_eq!(extract_base_url("https://api.example.com/v1/docs/llms.txt"), "https://api.example.com/v1/docs");
        assert_eq!(extract_base_url("https://example.com/"), "https://example.com");
        assert_eq!(extract_base_url("https://example.com"), "https://example.com");
    }
