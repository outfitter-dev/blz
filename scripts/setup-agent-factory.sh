...
export AGENT_SKIP_CARGO_TOOLS="${FACTORY_SKIP_CARGO_TOOLS:-1}"
export AGENT_SKIP_GO_TOOLS="${FACTORY_SKIP_GO_TOOLS:-1}"
export AGENT_INSTALL_BUN="${FACTORY_INSTALL_BUN:-1}"
export AGENT_TZ="${FACTORY_TZ:-utc}"
